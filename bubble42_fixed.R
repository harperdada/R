...
# ============================================================
# Squeeze Probability Engine helpers
# ============================================================
...
# ============================================================
# ACTION LOGIC — with RELEASE gate (shared by batch + single ticker)
# ============================================================
calc_action <- function(sqz_status, choppy, squeeze_ratio, mom_hist,
                         mom_delta, momentum_integrity, rsi) {
  case_when(
    choppy                                                        ~ "AVOID (CHOP)",
    sqz_status == "RELEASE"                                      ~ "DO NOTHING",
...
cat("--- RUNNING SQUEEZE PROBABILITY ENGINE v2 ---\n")
...
for (ticker in tickers) {
  ...
  out <- tryCatch({
    ...
    new_buy_action <- calc_action(sqz_status, choppy, squeeze_ratio,
                                   mom_hist, mom_delta, momentum_integrity, rsi)
...
# ============================================================
cat("\n--- SQUEEZE PROBABILITY ENGINE v2 — RESULTS ---\n\n")
